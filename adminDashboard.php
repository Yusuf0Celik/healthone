...
<body>
  ...
  <table class="w-100">
    <thead>
      <tr>
          <th scope="col" class="text-center p-3">Nr.</th>
    ...
    <tbody>
      ...
      <tr class="border-top">
        ...
        <td class="text-center py-3">
            <a href="./editProduct.php" class="formgroup btn btn-success">
        ...
        <td class="text-center py-3">
            <button type="submitRemove" name="removeBtn" class="btn btn-danger">
  ...
  <a class="btn btn-succes" href="./addProduct.php">
